...
class CustomTitleBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          // Logo & Title (Draggable window area)
          DragToMoveArea(
            child: Row(
          ...
          // Draggable spacer across empty area
          Expanded(
            child: isDesktop
            ...
            child: InkWell(
              ...
              child: Tooltip(
                message: vpn.isTunMode
                    ? 'TUN Mode (Full VPN - Requires Admin). Click to switch to System Proxy.'
                    : 'System Proxy Mode (No Admin needed). Click to switch to TUN Mode.',
          ...
          // Window Controls (Only on Windows / Linux - macOS uses native traffic lights on the left)
          if (isDesktop && !isMac) ...[
